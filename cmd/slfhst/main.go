...
import (
	...
	"github.com/nnnithinnn/slfhst/internal/setup"
...
func usageError(sub string) error {
  ...
  setup              post-boot setup: domain, firewall, update check,
                      render quadlets, start containers, backing
                      services, sync DNS (admin-run over SSH)
